...
{
    public class HanaCoreTestTable : IDisposable
    {
        ...
        public HanaCoreTestTable(HanaCoreProcessor processor, string schemaName, params string[] columnDefinitions)
        {
        ...
        public HanaCoreTestTable(string tableName, HanaCoreProcessor processor, string schemaName, params string[] columnDefinitions)
        {
            _schemaName = schemaName;
        ...
        private void Init(HanaCoreProcessor processor, IEnumerable<string> columnDefinitions)
        {
